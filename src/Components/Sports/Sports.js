...
import { fetchDataSportNews,moreInfoSport } from "../../Actions/Actions";

class Sport extends Component {
  componentDidMount() {
    this.props.getData(
      "https://newsapi.org/v2/top-headlines?country=us&category=sport&apiKey=74498e6f023d4358a296a9351a1ea043"
    );
  }
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    showMoreInfo: (value,name,num) => dispatch(moreInfoSport(value,name,num))
  };
}
