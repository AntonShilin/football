                    ...
                    <div className="text-center">
                      ...
                      >
                        {elem.videos.map((player, i) =>
                          player.title.search(/Highlights|Alternative|Extended|Official|Title|Celebrations/)===0 ? (
                            ""
                          ) : (
                            <p
                              key={i}
...
function mapDispatchToProps(dispatch) {
  return {
    getData: url => dispatch(fetchDataEngland(url)),
    showVideo: (value, url) => dispatch(moreInfoEngland(value, url)),
