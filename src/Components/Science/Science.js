...
import { fetchDataScienceNews,moreInfoScience } from "../../Actions/Actions";

class Science extends Component {
  componentDidMount() {
    this.props.getData(
      "https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=74498e6f023d4358a296a9351a1ea043"
    );
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        <div className="row">
          <div className="col">
            {this.props.data.science === null ? (
              <div className="mt-5">
                <div className="d-block mx-auto spinner-grow text-danger" />
                <p className="text-center">Loading ...</p>
              </div>
            ) : (
              this.props.data.science.articles.map((elem, i) => (
                <div
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    showMoreInfo: (value,name,num) => dispatch(moreInfoScience(value,name,num))
  };
}
